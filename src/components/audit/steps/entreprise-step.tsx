...
export function EntrepriseStep({ auditId, initialData, caObligatoire }: EntrepriseStepProps) {
  ...
  const progressPercent = Math.round((1 / AUDIT_SECTIONS.length) * 100);
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-8">
          <p className="mb-1 text-[11px] font-semibold uppercase tracking-widest text-gold-600">
            Étape 1 sur {AUDIT_SECTIONS.length}
          </p>
          <h1 className="mb-4 font-display text-2xl font-bold text-navy-800">Entreprise</h1>
